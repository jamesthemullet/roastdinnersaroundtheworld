...
### Step 6 — Open a pull request for the fix

If a fix was applied in Step 4, create a branch and open a PR:
...
gh pr create \
  --title "a11y: <short title matching the commit message>" \
  --body "## Summary

<one paragraph describing the accessibility issue and the fix applied>
...
If no fix was applied (no issues found), skip this step.
